...
let print = () => {
    ...
    console.log(formatTableRow(`${chalk['bold'](Object.keys(packageJson.bin)[0])}  <key-name>`))

    console.log(formatTableRow(`${chalk['bold']('key-name')}`, `Special Key Code / Key Name, see README)`))
